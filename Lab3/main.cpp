...
void display(){
	...
	mat4 persp_proj1 = perspective(45.0, (float)width/(float)height, 0.2, 100.0);
	...
	mat4 persp_proj3 = perspective(90.0, (float)width / (float)height, 0.1, 100.0);
	mat4 model3 = rotate_y_deg(identity_mat4(), 90);

	mat4 view4 = look_at(vec3(0,0,70),vec3(0,0,0),vec3(0,-1,0));
	...
	glUniformMatrix4fv(proj_mat_location, 1, GL_FALSE, ortho_proj2.m);
